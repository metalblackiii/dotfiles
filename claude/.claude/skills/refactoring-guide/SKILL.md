...
Refactoring is changing code structure without changing behavior. It's a disciplined practice, not a free-for-all. General design principles live in AGENTS.md — this skill covers when, why, and how to refactor.
