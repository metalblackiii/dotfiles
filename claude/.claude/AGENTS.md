...
| What | Edit Here |
|------|-----------|
| Shared instructions | `~/repos/dotfiles/claude/.claude/AGENTS.md` |
| Skills | `~/repos/dotfiles/claude/.claude/skills/<name>/SKILL.md` |
| Claude settings | `~/repos/dotfiles/claude/.claude/settings.json` |
| Claude instructions | `~/repos/dotfiles/claude/.claude/CLAUDE.md` |
| Claude hooks | `~/repos/dotfiles/claude/.claude/hooks/` |
| Claude commands | `~/repos/dotfiles/claude/.claude/commands/<name>.md` |
| Claude agents | `~/repos/dotfiles/claude/.claude/agents/<name>.md` |
| Claude scripts | `~/repos/dotfiles/claude/.claude/scripts/<name>.sh` |
| Codex settings | `~/repos/dotfiles/codex/.codex/config.toml` |

**Never edit via `~/.claude/` or `~/.codex/` paths** — those are symlinks.
