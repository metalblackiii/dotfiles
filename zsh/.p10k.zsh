# Generated by Powerlevel10k configuration wizard on 2024-05-21 at 17:10 PDT.
...
() {
  ...
  #############[ kubecontext: current kubernetes context (https://kubernetes.io/) ]#############
  # Always show kubecontext — wrong-cluster mistakes are costly in healthcare/HIPAA.
