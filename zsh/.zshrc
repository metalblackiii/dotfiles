...
[[ -f ~/repos/ptek-eng-toolbox/scripts/aws-sso-helper/aws-sso-profiles.sh ]] && \
  source ~/repos/ptek-eng-toolbox/scripts/aws-sso-helper/aws-sso-profiles.sh



# OLD STYLE AWS - Deprecated due to aws-sso-profiles.sh
