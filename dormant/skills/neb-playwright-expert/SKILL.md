...
description: ALWAYS invoke when writing, debugging, or planning E2E tests in neb-www using the Playwright framework and its custom component generation system.
---
