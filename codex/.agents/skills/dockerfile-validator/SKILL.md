...
```bash
cd /path/to/repo
SKILL_DIR="~/.claude/skills/dockerfile-validator"
...
```bash
cd /path/to/repo
bash ~/.claude/skills/dockerfile-validator/scripts/dockerfile-validate.sh Dockerfile
```
...
```bash
cd /path/to/repo
bash ~/.claude/skills/dockerfile-validator/scripts/dockerfile-validate.sh Dockerfile.prod
```

### Validate skill examples

```bash
cd ~/.claude/skills/dockerfile-validator
...
```bash
cd /path/to/repo
bash ~/.claude/skills/dockerfile-validator/scripts/test_validate.sh
```

Optional strict mode for CI environments that must enforce ShellCheck:

```bash
STRICT_SHELLCHECK=true bash ~/.claude/skills/dockerfile-validator/scripts/test_validate.sh
```
