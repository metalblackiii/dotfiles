---
name: the-fool
description: ALWAYS invoke when challenging ideas, plans, decisions, or proposals using structured critical reasoning. Invoke to play devil's advocate, run a pre-mortem, red team, or audit evidence and assumptions.
---
...
2. **Select** — Ask the user with the two-step mode selection below.
...
Ask the user to let the user choose how to challenge their idea.
...
- Ask the user for mode selection — never assume which mode
