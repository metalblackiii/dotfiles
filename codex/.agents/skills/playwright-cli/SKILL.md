---
name: playwright-cli
description: Use when automating browser interactions for web testing, form filling, screenshots, and data extraction via the playwright-cli CLI. Not for writing Playwright test files in neb-www — use neb-playwright-expert for that.
