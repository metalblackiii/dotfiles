...
echo "Running dockerfile-expert validator regression tests..."
echo ""
...
assert_output_contains \
    ...
    "No USER directive in final stage, but base image is non-root: gcr.io/distroless/static-debian11:nonroot"
assert_output_not_contains \
...
echo "PASS: dockerfile-expert validator regression tests"
