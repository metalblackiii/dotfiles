#!/usr/bin/env bash
#
# CI-friendly regression entrypoint for dockerfile-expert (validator).
...
echo "Running dockerfile-expert validator CI checks..."
...
echo "PASS: dockerfile-expert validator CI checks"
