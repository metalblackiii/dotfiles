#!/usr/bin/env bash
#
# Regression tests for dockerfile-expert (generator) scripts and examples.
#
# Covers:
...
echo "Running dockerfile-expert generator regression tests..."
...
echo "All dockerfile-expert generator regression tests passed."
