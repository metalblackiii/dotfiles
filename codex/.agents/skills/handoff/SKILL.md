---
name: handoff
description: ALWAYS invoke when ending a session with work in progress, or when context usage reaches 80% or exceeds 250K tokens (whichever comes first) and a fresh start would help.
---
