...
description: >
  ALWAYS invoke when challenging ideas, decisions, or proposals using structured critical reasoning and mental models. Triggers on "help me think through X", "challenge my thinking", "what am I missing", "apply mental models to this", "play devil's advocate", "stress test this idea", "poke holes in my plan", "help me decide between X and Y", "what are the second-order effects", "I'm stuck on a decision", "am I thinking about this right", or naming any specific model (SWOT, first principles, inversion, pre-mortem, 5 Whys, etc.). Not for routine code review (use self-review) or security audits (use security-review).
---
