...
### Orphan Modules (zero inbound imports)

Modules that no other module imports — potential dead packages:
...
Note: This finds modules with zero *importers*, not unused import statements within files. Entry-point modules (main, CLI) will appear as false positives.
