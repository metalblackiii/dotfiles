...
- [jeffallan/claude-skills](https://github.com/jeffallan/claude-skills) — microservices-architect, prompt-engineer, database-expert (merged from sql-pro + database-optimizer), api-designer, feature-forge, kubernetes-specialist, legacy-modernizer, spec-miner, the-fool, neb-playwright-expert (merged with neb-www docs)
