...
- [ykdojo/claude-code-tips](https://github.com/ykdojo/claude-code-tips) — ast-grep-patterns, handoff skills, status line, gha-expert failure analysis workflow (adapted from gha skill), writing-agents-md usage audit mode (inspired by review-claudemd)
